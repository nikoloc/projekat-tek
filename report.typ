...
&= - R_2 / R_1 dot 1 / (1 + j omega R_2 C) dot underline(V_"in") $ <eq-v-out>
...
На основу једначине @eq-v-out, видимо да преносна функција садржи негативан предзнак. Ово указује на то да је коло конфигурисано као инвертујући појачавач, што у фазном домену одговара померају од $180°$ за ниске фреквенције. Са порастом фреквенције, присуство кондензатора $C$ у грани повратне спреге додатно мења фазни став како се приближавамо граничној вредности.

Максимално појачање кола у пропусном опсегу (за $omega -> 0$) дефинисано је односом отпорника:

$ A = - R_2 / R_1 $

За вредности $R_1 = 1 k Omega$ и $R_2 = 20 k Omega$, теоријско појачање износи:

$ |A| = (20 k Omega) / (1 k Omega) = 20 $

Изражено у децибелима, ово појачање износи $20 log_10 (20) approx 26$ dB. График на Слици 4 потврђује да појачање одржава константну вредност до фреквенција реда $10^3$ Hz, након чега наступа пад од $-20$ dB по декади.
