...
Зато се најчешће поступа на следећи начин - дефишемо граничну фреквенцију $f_"cutoff"$ као онз фреквенцију за коју појачање филтера падне
...
максималне вредности. Овој вредности одговара пад од $-3$ dB од на децибелској скали.
...
Мерење је одрађено у лабораторији на факултету. Коло је састављено на протоборду, а за изворе напајања, као и саму мерну апаратуру је
коришћен ADALM2000@ADALM.

ovde dodati sliku iz laba
...
(@fig-measure-ac-analysis). Резулатати мерења су сачувани и искоришћени за графичко приказавање резултата у Python-у.

#figure(
  image("dest/measure-transient.png"),
  caption: [Појачање улазног сигнала фреквенције *koliko bese, zab sam* Hz измерено у лабораторији],
